export const statistics = {
    ...
    methods:{
        GetFirstAndLastDate:function(){
            ...
            this.date = lastDayOfMonth.toISOString().substring(0, 10);
        },
        get:function(){
            var self = this;
        ...
        actionStatistics:function(){
            ...
            axios.post(this.parent.url+"/side/actionStatistic?auth="+this.parent.user.auth,data).then(function(response){
        ...
        <div class="wrapper">
            <div class="flex panel">
                ...
                <div class="w20 ptb15 al">
                    <a href="#" class="btn" @click.prevent="parent.formData.copy = data.multi;$refs.copy.active=1;">
